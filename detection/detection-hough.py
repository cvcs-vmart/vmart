...
IMG_NAME = 'cropped-742-300-808-369'
...
if max == height:
    img = cv2.resize(img, (l_min, l_max), interpolation=cv2.INTER_LINEAR)
else:
    img = cv2.resize(img, (l_max, l_min), interpolation=cv2.INTER_LINEAR)
